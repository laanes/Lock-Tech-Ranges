<?php require_once('lock_tech_ranges.class.local.php');
...
class Lock_Tech_Ranges_Controller extends Lock_Tech_Ranges {
	...
	$image_path[] = "http://lock-tech.co.uk/shop" . "/images/uploads/productImages/" . str_replace('productImages/', '', $value['image']);;
...
$range_products = new Lock_Tech_Ranges_Controller(1);
